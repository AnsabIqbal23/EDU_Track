...
const DeleteSchedule = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`http://localhost:8081/api/schedules/delete`, {
                method: "DELETE",
                headers: {
            ...
            if (response.ok) {
                ...
                setToastMessage(errorData.message || "Failed to delete schedule.")
                setToastVariant("destructive")
            }
        } catch (error) {
            console.error("Error deleting schedule:", error)
            setToastMessage("Failed to delete schedule. Please try again later.")
            setToastVariant("destructive")
        } finally {
            setLoading(false)
        }
                            ...
                            <Card className="bg-gray-800 border-gray-700 max-w-2xl mx-auto shadow-lg">
                                <CardHeader>
                                    ...
                                    <CardDescription className="text-gray-400">
                                        Enter the schedule details to delete the corresponding course schedule.
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
